classdef NSTransH_VDconst_contRi < ode_continuation
    ...
    methods
        %% Constructor
        function obj=NSTransH_VDconst_contRi(mesh_obj,settings,h,num_iter,save_iter,x0)
            if nargin<4
                error('NSTransH_VDconst_contRi: Not enough Input argument');
            else
        ...
        function x0=get_initial_solution(obj)
            ...
            settings.Q=obj.Q;
            prof_obj=NSTransH_VDconst(obj.mesh_obj,settings);
