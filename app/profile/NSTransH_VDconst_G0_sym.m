classdef NSTransH_VDconst_G0_sym < solv_prof
    ...
    methods
        %% Constructor
        function obj=NSTransH_VDconst_G0_sym(mesh_obj,settings,ini_prof)
            switch nargin
                case 2
...
%             D2H0=D2M*H0;
        ...
        function obj=get_ini(obj,x0)
            if nargin>1
                ...
                U0=obj.G0/(-2)*((1-obj.mesh_obj.pts.^2));%+sin(pi*obj.mesh_obj.pts));
