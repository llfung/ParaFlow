classdef chebyshev < mesh_class
%% Mesh and Differential Matricecs from Chebyshev Collocation Method
% Based on J.A.C. Weideman and SC Reddy's script
% ACM TOMS, Vol. 26, pp. 465--519 (2000)
